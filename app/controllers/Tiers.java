...
public class Tiers extends Controller {
    ...
    public static void before() {
        ...
        String filtre = SessionUtil.getSessionParam(
                SessionUtil.SESSION_PARAM_TIERS_FILTRE, true, "");
        Logger.debug("Filre = %s", filtre);
        renderArgs.put("Tiers_filtre", filtre);

        // Récupération de la pagination
        // Dans l'ordre params puis session
        String pageParam = SessionUtil.getSessionParam(
                SessionUtil.SESSION_PARAM_TIERS_PAGE, true, "1");
